...
1. 增加了元数据导出功能 
   当前仅支持tachiyomi格式，若有其他需求欢迎在issue中提出。
2. 增加了将特典内容与正篇内容分开的选项
   开启该选项后，特典内容会被保存到该漫画文件夹的“特典”文件夹下，正篇内容则是保存到该漫画文件夹的“正篇”文件夹下。
3. 增加了更加灵活的压缩策略
   目前可以选择在下载后不进行压缩，下载整部漫画后进行压缩，以及下载完单话后即进行压缩
4. 对UI进行了优化
